    ...
    <AppLayout title="Inicio">
        ...
        <template #>
            <div class="grid w-full h-full justify-center items-center">
                <Modal :show="modal" :max-width="'sm'" @close="callback">
                    <div class="flex justify-end w-full pt-2 pr-2">
                        <button class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition" @click="modal = false, form.reset()">
                    ...
                    <form class="p-2 grid gap-2" @submit.prevent="submit">
                        <InputLabel for="categoria" value="Nueva Categoria" class=" text-md font-semibold"/>
                    ...
                    <div class="max-w-full bg-white overflow-hidden shadow-xl sm:rounded-lg p-2 md:flex md:justify-between md:items-center">
                        <div class="flex flex-col justify-between items-center">
                            <div class="grid gap-2 w-full items-center">
                                ...
                                <div class="grid md:grid-cols-4 lg:grid-cols-6 grid-cols-2 w-full gap-2 items-center p-2">
